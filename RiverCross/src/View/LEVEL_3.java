...
public class LEVEL_3 {
    ...
    private void renderChars(GraphicsContext gc, Sprite2 background, Sprite2 raft, Sprite2 boy, Sprite2 girl, Sprite2 woman,
                        Sprite2 savebtn, Sprite2 resetbtn, Sprite2 loadbtn, Sprite2 showbtn, Sprite2 bag, Sprite2 man
                        ,Sprite2 movebtn)
    {
    ...
    public void scene_build() {
        ...
        scene.setOnMouseClicked((MouseEvent) -> {
            ...
            if ((x >= resetbtn.getPositionX()) && (x < resetbtn.getPositionX() + resetbtn.getWidth())
                ...
                bag.setLocation(1);
                // ************
                renderChars(gc, background, raft, boy,girl,woman,savebtn,resetbtn,loadbtn,showbtn,bag,man,movebtn);

                controller3.resetGame();
            }
            ...
            if ((x >= loadbtn.getPositionX()) && (x < loadbtn.getPositionX() + loadbtn.getWidth())
                ...
                if (controller3.check_load2()) {
                    controller3.loadGame2();
                    boy.setPositionX(controller3.x1.getPositionX());
                    boy.setPositionY(controller3.x1.getPositionY());
                    raft.setPositionX(controller3.x2.getPositionX());
                    raft.setPositionY(controller3.x2.getPositionY());
                    girl.setPositionX(controller3.x3.getPositionX());
                    girl.setPositionY(controller3.x3.getPositionY());
                    man.setPositionX(controller3.x4.getPositionX());
                    man.setPositionY(controller3.x4.getPositionY());
                    woman.setPositionX(controller3.x5.getPositionX());
                    woman.setPositionY(controller3.x5.getPositionY());
                    bag.setPositionX(controller3.x6.getPositionX());
                    bag.setPositionY(controller3.x6.getPositionY());
                    boy.setRank(controller3.x1.getRank());
                    numOfSails = boy.getRank();
                    boy.setLocation(controller3.x1.getLocation());
                    raft.setLocation(controller3.x2.getLocation());
                    girl.setLocation(controller3.x3.getLocation());
                    man.setLocation(controller3.x4.getLocation());
                    woman.setLocation(controller3.x5.getLocation());
                    renderChars(gc, background, raft, boy,girl,woman,savebtn,resetbtn,loadbtn,showbtn,bag,man,movebtn);
                } else {
            ...
            if ((x >= savebtn.getPositionX()) && (x < savebtn.getPositionX() + savebtn.getWidth())
                ...
                //controller3.saveGame2(boy, raft, girl, man, woman,bag);
                controller3.saveGame2(boy, raft, girl, man, woman, bag);
            }
            if (raft.getPositionY() == 320) {
                ...
                if ((x >= boy.getPositionX()) && (x < boy.getPositionX() + boy.getWidth())
                    ...
                    controller3.setCrossersMovingUp("boy");
                    if (controller3.CrosserOnRift()) {
                        ...
                        System.out.println(controller3.canMove(controller3.getCrossers(), true));
                    } else {
                        showerror("hehehhe");
                    }

                } else if ((x >= bag.getPositionX()) && (x < (bag.getPositionX() + bag.getWidth()))
                        && (y >= bag.getPositionY()) && (y < bag.getPositionY() + bag.getHeight() && (bag.getLocation() == 1))
                        && (raft.getPositionY() == 320)) {

                    controller3.setCrossersMovingUp("bag");
                    if(controller3.CrosserOnRift()) {
                        ...
                        && (raft.getPositionY() == 320)) {
                    controller3.setCrossersMovingUp("girl");
                    if (controller3.CrosserOnRift()) {
                        ...
                        && (raft.getPositionY() == 320)) {
                    controller3.setCrossersMovingUp("man");
                    if (controller3.CrosserOnRift()) {
                        ...
                        && (raft.getPositionY() == 320)) {
                    controller3.setCrossersMovingUp("woman");
                    if (controller3.CrosserOnRift()) {
                        ...
                        System.out.println(controller3.getCrossers().size());
                        System.out.println(controller3.canMove(controller3.getCrossers(), true));
                        showerror("kekeowfwefw");
                    }
                } else if ((x >= 500) && (x < 500 + button_img.getWidth()) && (y >= 0)
                        && (y < 0 + button_img.getHeight())) {
                    if (controller3.canMove(controller3.getCrossers(), true)) {
                        ...
                        if (controller3.success()) {
                            ...
                            //*****************************************************************************************
                            //controller3.saveGame(boy, raft, girl, man, woman);
                            //*****************************************************************************************
                    ...
                    if ((x >= boy.getPositionX()) && (x < boy.getPositionX() + boy.getWidth())
                        ...
                        controller3.setCrossersMovingDown("boy");
                        if (controller3.CrosserOnRift()) {
                    ...
                    controller3.setCrossersMovingDown("girl");
                    if (controller3.CrosserOnRift()) {
                    ...
                    controller3.setCrossersMovingDown("man");
                    if (controller3.CrosserOnRift()) {
                        man.setPositionX(360);
                ...
                controller3.setCrossersMovingDown("bag");
                if (controller3.CrosserOnRift()) {
                    bag.setPositionX(360);
                ...
                controller3.setCrossersMovingDown("woman");
                if (controller3.CrosserOnRift()) {
                    woman.setPositionX(360);
                    woman.setPositionY(260);
                    woman.setLocation(3);
                    renderChars(gc, background, raft, boy,girl,woman,savebtn,resetbtn,loadbtn,showbtn,bag,man,movebtn); System.out.println("raft location is " + raft.getPositionY());
                    // moveSprite(plant, wolf, goat, farmer, gc, image, image2, button_img);
                    System.out.println(controller3.canMove(controller3.getCrossers(), true));
                } else {
                    System.out.println(controller3.getCrossers().size());
